...
<section id="listForm">
    ...
    <table>
        ...
        %>
        <tr>
            <td align="center"><%=articleList.get(i).getBoard_num() %>
            </td>
            <td>
            ...
            <td align="center"><%=articleList.get(i).getBoard_name() %>
            </td>
            <td align="center"><%=articleList.get(i).getBoard_date() %>
            </td>
            <td align="center"><%=articleList.get(i).getBoard_readcount() %>
            </td>
        </tr>
